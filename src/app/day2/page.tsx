    ...
    <div className="min-h-screen bg-surface">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="rounded-2xl border-2 border-[#0891B2]/20 bg-[#ECFEFF] p-5 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#155E75] leading-relaxed">
                ...
                Bronze, Silver, Gold — becoming cleaner and more useful at every step.
              </p>
            </div>
          </div>
        ...
        <section className="mb-8">
          <div className="mb-5">
            <h3 className="text-lg font-semibold text-gray-900">Data in Motion — Bronze → Silver → Gold</h3>
            <p className="text-sm text-gray-500 mt-1">
              Follow a single commission record through all three stages. See exactly what changes — and why — at each step.
            </p>
          </div>
          <MedallionFlow />
